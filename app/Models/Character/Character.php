...
class Character extends Model
{
    ...
    **********************************************************************************************/
    ...
    /**
     * get all children of this character
     */
    public function children()
    {
        return $this->hasMany('App\Models\Character\CharacterLink', 'parent_id');
    }

    /**
     * get parent of this character
     */
    public function parent()
    {
        return $this->hasOne('App\Models\Character\CharacterLink', 'child_id');
    }
