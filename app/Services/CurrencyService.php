...
class CurrencyService extends Service
{
    ...
    */
    ...
    public function deleteCurrency($currency, $user)
    {
        ...
        try {
            if (DB::table('user_currencies')->where([['currency_id', '=', $currency->id], ['quantity', '>', 0]])->exists()) {
                throw new \Exception('At least one user currently owns this currency. Please remove the currency before deleting it.');
            }
