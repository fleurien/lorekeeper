    ...
    public function updateEvent($event, $data, $user) {
        ...
        try {
            ...
            if (isset($data['figure_id'])) {
                ...
                if (count($figures) != count($data['figure_id'])) {
                    throw new \Exception('One or more of the selected figures does not exist.');
                }
            } else {
                $figures = [];
            }
            ...
            if (isset($data['faction_id'])) {
                ...
                if (count($factions) != count($data['faction_id'])) {
                    throw new \Exception('One or more of the selected factions does not exist.');
                }
            } else {
                $factions = [];
            }
            ...
            if (isset($data['news_id'])) {
                ...
                if (count($newses) != count($data['news_id'])) {
                    throw new \Exception('One or more of the selected newses does not exist.');
                }
            } else {
                $newses = [];
            }
            ...
            if (isset($data['prompt_id'])) {
                ...
                if (count($prompts) != count($data['prompt_id'])) {
                    throw new \Exception('One or more of the selected prompts does not exist.');
                }
            } else {
                $prompts = [];
            }
