        ...
        <div class="submission-character mb-3 card">
            ...
            <table>
                <tr class="character-reward-row">
                    ...
                    @if($expanded_rewards)
                    <td>
                        {!! Form::select('character_rewardable_type[]', ['Item' => 'Item', 'Currency' => 'Currency', 'LootTable' => 'Loot Table', 'Award' => ucfirst(__('awards.award')), 'StatusEffect' => 'Status Effect'], null, ['class' => 'form-control character-rewardable-type', 'placeholder' => 'Select Reward Type']) !!}
                    </td>
                    <td class="lootDivs">
