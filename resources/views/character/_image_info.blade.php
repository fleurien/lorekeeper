...
<div class="col-md-5 d-flex">
    <div class="card character-bio w-100" style="background-color:#f9f9f7; border radius: 10px;">
        ...
        <div class="card-body tab-content" style="background-color:#f9f9f7; border-radius:3px;">
            ...
            <div class="tab-pane fade show active" id="info-{{ $image->id }}">
                <div class="row">
                    <div class="character-masterlist-categories col-10" style="margin:20px; font-size:20px; text-align:right;">
                        <p>
                ...
                @if(Auth::check() && Auth::user()->hasPower('manage_characters'))
                    <div class="mt-3">
                        <a href="#" class="btn btn-outline-info btn-sm edit-notes" data-id="{{ $image->id }}"><i class="fas fa-cog"></i> Add notes</a>
                    </div>
                @endif
                ...
                @if(Auth::check() && Auth::user()->hasPower('manage_characters'))
                    <div class="mt-3">
                        <a href="#" class="btn btn-outline-info btn-sm edit-features mb-3" data-id="{{ $image->id }}"><i class="fas fa-cog"></i> Staff Edit</a>
                    </div>
                @endif
            </div>
            ...
            <div class="tab-pane fade show" id="stats">
