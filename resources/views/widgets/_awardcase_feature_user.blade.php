@if($target->awards->where('is_featured',1)->where('pivot.count','>',0)->count() && $count)
    <div class="{{ $float ? 'float-md-right ml-md-4' : '' }}" style="display: block;max-width: 200px;position: relative;left: -15%;margin-bottom: -30%;bottom: 5%;"><div class="row justify-content-center align-items-center">
