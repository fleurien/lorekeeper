@if (isset($submission->content_warning))
    <img class="img-thumbnail" src="{{ asset('/images/content_warning.png') }}" style="min-width:200px;" alt="Content Warning" />
@elseif(isset($submission->hash))
    <img class="img-thumbnail" src="{{ $submission->thumbnailUrl }}" style="min-width:200px; max-height:200px;" alt="Submission thumbnail" />
@else
